...
public class MyTileService extends TileService {
    ...
    public void onStartListening() {
        ...
        Toast.makeText(this,"Tile started listening",Toast.LENGTH_LONG).show();
    }
    ...
    public void onStopListening() {
        ...
        Toast.makeText(this,"Tile stopped listening",Toast.LENGTH_LONG).show();
    }
    ...
    public void onClick() {
        ...
        Toast.makeText(this,"Tile clicked",Toast.LENGTH_LONG).show();
    ...
    public void onDestroy() {
        ...
        Toast.makeText(this,"Tile destroyed",Toast.LENGTH_LONG).show();
    }
